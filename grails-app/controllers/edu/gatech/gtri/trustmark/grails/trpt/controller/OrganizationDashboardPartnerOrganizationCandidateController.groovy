...
class OrganizationDashboardPartnerOrganizationCandidateController {
    ...
    Object findOne(final ProtectedEntityPartnerCandidateFindOneRequest entityPartnerCandidateFindOneRequest) {
        ...
        final ValidationResponse validationResponse = validationResponse(organizationService.findOne((OAuth2AuthenticationToken) SecurityContextHolder.getContext().getAuthentication(), entityPartnerCandidateFindOneRequest))
