...
class Organization implements ProtectedEntity {

    public static final Ord<Organization> organizationOrdId = Ord.<Organization, Long> contramap({ Organization organization -> organization.idHelper() }, LongUtility.longOrd);
    ...
    org.gtri.fj.data.List<ProtectedEntityPartnerCandidate> protectedEntityPartnerCandidateSetHelper() { organizationPartnerOrganizationCandidateSetHelper().map({ organizationPartnerOrganizationCandidate -> (ProtectedEntityPartnerCandidate) organizationPartnerOrganizationCandidate }) }
    ...
    org.gtri.fj.data.List<ProtectedEntityTrustInteroperabilityProfileUri> protectedEntityTrustInteroperabilityProfileUriSetHelper() { organizationTrustInteroperabilityProfileUriSetHelper().map({ organizationTrustInteroperabilityProfileUri -> (ProtectedEntityTrustInteroperabilityProfileUri) organizationTrustInteroperabilityProfileUri }) }
