...
@GrailsCompileStatic
class OrganizationPartnerOrganizationCandidate implements ProtectedEntityPartnerCandidate<Organization, PartnerOrganizationCandidate> {
    ...
    PartnerOrganizationCandidate partnerCandidateHelper() { getPartnerOrganizationCandidate() }
