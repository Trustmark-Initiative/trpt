...
class PartnerOrganizationCandidate implements PartnerCandidate {
    ...
    static hasMany = [partnerOrganizationCandidateTrustInteroperabilityProfileUriSet: PartnerOrganizationCandidateTrustInteroperabilityProfileUri,
    ...
    static belongsTo = [trustmarkBindingRegistryOrganizationMapUri: TrustmarkBindingRegistryOrganizationMapUri]
    ...
    static final org.gtri.fj.data.List<PartnerOrganizationCandidate> findAllByOrganizationInHelper(final org.gtri.fj.data.List<Organization> organizationList) {
        ...
        fromNull(ProtectedSystem.executeQuery("SELECT DISTINCT partnerOrganizationCandidate " + "FROM PartnerOrganizationCandidate partnerOrganizationCandidate " + "JOIN partnerOrganizationCandidate.trustmarkBindingRegistryOrganizationMapUri trustmarkBindingRegistryOrganizationMapUri " + "JOIN trustmarkBindingRegistryOrganizationMapUri.trustmarkBindingRegistryUri trustmarkBindingRegistryUri " + "JOIN trustmarkBindingRegistryUri.trustmarkBindingRegistrySet trustmarkBindingRegistry " + "WHERE trustmarkBindingRegistry.organization IN (:organizationList) ",
