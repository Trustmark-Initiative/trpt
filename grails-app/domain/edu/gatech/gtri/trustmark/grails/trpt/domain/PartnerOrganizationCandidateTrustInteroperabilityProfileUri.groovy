...
class PartnerOrganizationCandidateTrustInteroperabilityProfileUri implements Evaluation<PartnerOrganizationCandidate> {
    ...
    static hasMany = [partnerOrganizationCandidateMailEvaluationUpdateSet: PartnerOrganizationCandidateMailEvaluationUpdate]

    PartnerOrganizationCandidate partnerOrganizationCandidateHelper() { getPartnerOrganizationCandidate() }

    PartnerOrganizationCandidate partnerCandidateHelper() { partnerOrganizationCandidateHelper() }
    ...
    static org.gtri.fj.data.List<P3<PartnerOrganizationCandidate, TrustInteroperabilityProfileUri, Option<PartnerOrganizationCandidateTrustInteroperabilityProfileUri>>> findByPartnerOrganizationCandidateAndTrustInteroperabilityProfileUriAndProtectedSystemHelper(final org.gtri.fj.data.List<PartnerOrganizationCandidate> partnerOrganizationCandidateList,
        ...
        return fromNull(PartnerOrganizationCandidateTrustInteroperabilityProfileUri.executeQuery("SELECT DISTINCT partnerOrganizationCandidate, trustInteroperabilityProfileUri, partnerOrganizationCandidateTrustInteroperabilityProfileUri " + "FROM PartnerOrganizationCandidate partnerOrganizationCandidate, TrustInteroperabilityProfileUri trustInteroperabilityProfileUri " + "JOIN partnerOrganizationCandidate.trustmarkBindingRegistryOrganizationMapUri trustmarkBindingRegistryOrganizationMapUri " + "JOIN trustmarkBindingRegistryOrganizationMapUri.trustmarkBindingRegistryUri trustmarkBindingRegistryUri " + "JOIN trustmarkBindingRegistryUri.trustmarkBindingRegistrySet trustmarkBindingRegistry " + "JOIN trustmarkBindingRegistry.organization organization " + "JOIN trustInteroperabilityProfileUri.organizationTrustInteroperabilityProfileUriSet organizationTrustInteroperabilityProfileUri " + "JOIN organizationTrustInteroperabilityProfileUri.organization organizationTrustInteroperabilityProfileUriOrganization " + "LEFT JOIN PartnerOrganizationCandidateTrustInteroperabilityProfileUri partnerOrganizationCandidateTrustInteroperabilityProfileUri " + "ON partnerOrganizationCandidateTrustInteroperabilityProfileUri.partnerOrganizationCandidate = partnerOrganizationCandidate " + "AND partnerOrganizationCandidateTrustInteroperabilityProfileUri.trustInteroperabilityProfileUri = trustInteroperabilityProfileUri " + "WHERE organization = organizationTrustInteroperabilityProfileUriOrganization " + (partnerOrganizationCandidateList.isNotEmpty() ? "AND (partnerOrganizationCandidate IN (:partnerOrganizationCandidateList)) " : "") + (trustInteroperabilityProfileUriList.isNotEmpty() ? "AND (trustInteroperabilityProfileUri IN (:trustInteroperabilityProfileUriList)) " : "") + (organizationList.isNotEmpty() ? "AND (organization IN (:organizationList)) " : "") + "ORDER BY partnerOrganizationCandidateTrustInteroperabilityProfileUri.evaluationAttemptLocalDateTime ",
                org.gtri.fj.data.TreeMap.iterableTreeMap(StringUtility.stringOrd, org.gtri.fj.data.Option.somes(org.gtri.fj.data.List.arrayList(Option.iif(partnerOrganizationCandidateList.isNotEmpty(), P.p("partnerOrganizationCandidateList", partnerOrganizationCandidateList.toJavaList())),
    ...
    org.gtri.fj.data.List<Evaluation<PartnerOrganizationCandidate>> findAllByPartnerCandidateTrustInteroperabilityProfileUriHelper() {
        fromNull(PartnerOrganizationCandidateTrustInteroperabilityProfileUriHistory.findAllByPartnerOrganizationCandidateAndTrustInteroperabilityProfileUri(partnerOrganizationCandidateHelper(), trustInteroperabilityProfileUriHelper()))
                .map({ collection -> iterableList(collection) })
                .orSome(org.gtri.fj.data.List.<PartnerOrganizationCandidateTrustInteroperabilityProfileUriHistory> nil())
                .map({ partnerOrganizationCandidateTrustInteroperabilityProfileUriHistory -> (Evaluation<PartnerOrganizationCandidate>) partnerOrganizationCandidateTrustInteroperabilityProfileUriHistory })
    }
}
