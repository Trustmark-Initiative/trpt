...
class PartnerSystemCandidate implements PartnerCandidate {
    ...
    static hasMany = [partnerSystemCandidateTrustInteroperabilityProfileUriSet: PartnerSystemCandidateTrustInteroperabilityProfileUri,
    ...
    static belongsTo = [trustmarkBindingRegistrySystemMapUriType: TrustmarkBindingRegistrySystemMapUriType]
    ...
    static final org.gtri.fj.data.List<PartnerSystemCandidate> findAllByOrganizationInAndTypeInHelper(final org.gtri.fj.data.List<Organization> organizationList, final org.gtri.fj.data.List<TrustmarkBindingRegistrySystemType> typeList) {
        ...
        fromNull(ProtectedSystem.executeQuery("SELECT DISTINCT partnerSystemCandidate " + "FROM PartnerSystemCandidate partnerSystemCandidate " + "JOIN partnerSystemCandidate.trustmarkBindingRegistrySystemMapUriType trustmarkBindingRegistrySystemMapUriType " + "JOIN trustmarkBindingRegistrySystemMapUriType.trustmarkBindingRegistryUri trustmarkBindingRegistryUri " + "JOIN trustmarkBindingRegistryUri.trustmarkBindingRegistrySet trustmarkBindingRegistry " + "WHERE trustmarkBindingRegistry.organization IN (:organizationList) " + "AND partnerSystemCandidate.type IN (:typeList)",
