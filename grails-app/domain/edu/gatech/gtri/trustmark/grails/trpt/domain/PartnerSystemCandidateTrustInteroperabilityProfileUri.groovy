...
class PartnerSystemCandidateTrustInteroperabilityProfileUri implements Evaluation<PartnerSystemCandidate> {
    ...
    static hasMany = [partnerSystemCandidateMailEvaluationUpdateSet: PartnerSystemCandidateMailEvaluationUpdate]
    ...
    static org.gtri.fj.data.List<P3<PartnerSystemCandidate, TrustInteroperabilityProfileUri, Option<PartnerSystemCandidateTrustInteroperabilityProfileUri>>> findByPartnerSystemCandidateAndTrustInteroperabilityProfileUriAndProtectedSystemHelper(final org.gtri.fj.data.List<PartnerSystemCandidate> partnerSystemCandidateList,
        ...
        return fromNull(PartnerSystemCandidateTrustInteroperabilityProfileUri.executeQuery("SELECT DISTINCT partnerSystemCandidate, trustInteroperabilityProfileUri, partnerSystemCandidateTrustInteroperabilityProfileUri " + "FROM PartnerSystemCandidate partnerSystemCandidate, TrustInteroperabilityProfileUri trustInteroperabilityProfileUri " + "JOIN partnerSystemCandidate.trustmarkBindingRegistrySystemMapUriType trustmarkBindingRegistrySystemMapUriType " + "JOIN trustmarkBindingRegistrySystemMapUriType.trustmarkBindingRegistryUri trustmarkBindingRegistryUri " + "JOIN trustmarkBindingRegistryUri.trustmarkBindingRegistrySet trustmarkBindingRegistry " + "JOIN trustmarkBindingRegistry.organization organization " + "JOIN organization.protectedSystemSet organizationProtectedSystem " + "JOIN trustInteroperabilityProfileUri.protectedSystemTrustInteroperabilityProfileUriSet protectedSystemTrustInteroperabilityProfileUri " + "JOIN protectedSystemTrustInteroperabilityProfileUri.protectedSystem protectedSystemTrustInteroperabilityProfileUriProtectedSystem " + "LEFT JOIN PartnerSystemCandidateTrustInteroperabilityProfileUri partnerSystemCandidateTrustInteroperabilityProfileUri " + "ON partnerSystemCandidateTrustInteroperabilityProfileUri.partnerSystemCandidate = partnerSystemCandidate " + "AND partnerSystemCandidateTrustInteroperabilityProfileUri.trustInteroperabilityProfileUri = trustInteroperabilityProfileUri " + "WHERE organizationProtectedSystem = protectedSystemTrustInteroperabilityProfileUriProtectedSystem " + (partnerSystemCandidateList.isNotEmpty() ? "AND (partnerSystemCandidate IN (:partnerSystemCandidateList)) " : "") + (trustInteroperabilityProfileUriList.isNotEmpty() ? "AND (trustInteroperabilityProfileUri IN (:trustInteroperabilityProfileUriList)) " : "") + (protectedSystemList.isNotEmpty() ? "AND (organizationProtectedSystem IN (:protectedSystemList)) " : "") + "ORDER BY partnerSystemCandidateTrustInteroperabilityProfileUri.evaluationAttemptLocalDateTime ",
                org.gtri.fj.data.TreeMap.iterableTreeMap(StringUtility.stringOrd, org.gtri.fj.data.Option.somes(org.gtri.fj.data.List.arrayList(Option.iif(partnerSystemCandidateList.isNotEmpty(), P.p("partnerSystemCandidateList", partnerSystemCandidateList.toJavaList())),
