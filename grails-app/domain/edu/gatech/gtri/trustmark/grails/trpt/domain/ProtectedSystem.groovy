...
import org.gtri.fj.lang.LongUtility
...
class ProtectedSystem implements ProtectedEntity {

    public static final Ord<ProtectedSystem> protectedSystemOrdId = Ord.<ProtectedSystem, Long> contramap({ ProtectedSystem protectedSystem -> protectedSystem.idHelper() }, LongUtility.longOrd);
    ...
    org.gtri.fj.data.List<ProtectedEntityPartnerCandidate> protectedEntityPartnerCandidateSetHelper() { protectedSystemPartnerSystemCandidateSetHelper().map({ protectedSystemPartnerSystemCandidate -> (ProtectedEntityPartnerCandidate) protectedSystemPartnerSystemCandidate }) }
    ...
    org.gtri.fj.data.List<ProtectedEntityTrustInteroperabilityProfileUri> protectedEntityTrustInteroperabilityProfileUriSetHelper() { protectedSystemTrustInteroperabilityProfileUriSetHelper().map({ protectedSystemTrustInteroperabilityProfileUri -> (ProtectedEntityTrustInteroperabilityProfileUri) protectedSystemTrustInteroperabilityProfileUri }) }
