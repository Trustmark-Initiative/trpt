...
@GrailsCompileStatic
class ProtectedSystemTrustInteroperabilityProfileUri implements ProtectedEntityTrustInteroperabilityProfileUri<ProtectedSystem> {
    ...
    static belongsTo = [protectedSystem                : ProtectedSystem,
