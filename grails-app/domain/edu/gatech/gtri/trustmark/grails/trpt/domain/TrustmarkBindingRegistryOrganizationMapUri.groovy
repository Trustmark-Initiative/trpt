...
class TrustmarkBindingRegistryOrganizationMapUri implements Uri {
    ...
    static PagedResultList<TrustmarkBindingRegistryOrganizationMapUri> findAllHelper(final long offset, final long max) {
        fromNull((PagedResultList<TrustmarkBindingRegistryOrganizationMapUri>) TrustmarkBindingRegistryOrganizationMapUri.createCriteria().list(offset: offset, max: max) {})
                .orSome(new PagedResultList<TrustmarkBindingRegistryOrganizationMapUri>(null));
    }
}
