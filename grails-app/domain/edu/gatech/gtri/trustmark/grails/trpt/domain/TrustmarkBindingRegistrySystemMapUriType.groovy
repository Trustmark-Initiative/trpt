...
class TrustmarkBindingRegistrySystemMapUriType implements Uri {
    ...
    static PagedResultList<TrustmarkBindingRegistrySystemMapUriType> findAllHelper(final long offset, final long max) {
        fromNull((PagedResultList<TrustmarkBindingRegistrySystemMapUriType>) TrustmarkBindingRegistrySystemMapUriType.createCriteria().list(offset: offset, max: max) {})
                .orSome(new PagedResultList<TrustmarkBindingRegistrySystemMapUriType>(null));
    }
