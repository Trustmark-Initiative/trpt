...
import edu.gatech.gtri.trustmark.grails.trpt.domain.PartnerOrganizationCandidateTrustInteroperabilityProfileUriHistory;
import edu.gatech.gtri.trustmark.grails.trpt.domain.PartnerOrganizationCandidateTrustmarkUri;
...
import edu.gatech.gtri.trustmark.grails.trpt.service.job.resolver.DatabaseCacheTrustInteroperabilityProfileResolver;
import edu.gatech.gtri.trustmark.grails.trpt.service.job.resolver.DatabaseCacheTrustmarkDefinitionResolver;
import edu.gatech.gtri.trustmark.grails.trpt.service.job.resolver.DatabaseCacheTrustmarkResolver;
import edu.gatech.gtri.trustmark.grails.trpt.service.job.resolver.DatabaseCacheTrustmarkStatusReportResolver;
...
public class JobUtilityForPartnerOrganizationCandidateTrustInteroperabilityProfileUri {
    ...
    private static void synchronizePartnerOrganizationCandidateTrustInteroperabilityProfileUri(
        ...
        RetryTemplateUtility.retry(() -> PartnerOrganizationCandidateTrustInteroperabilityProfileUri.withTransactionHelper(() -> PartnerOrganizationCandidateTrustInteroperabilityProfileUri.findByPartnerOrganizationCandidateAndTrustInteroperabilityProfileUriHelper(
