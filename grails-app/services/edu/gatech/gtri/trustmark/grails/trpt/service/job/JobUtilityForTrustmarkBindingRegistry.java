...
import static edu.gatech.gtri.trustmark.grails.trpt.service.file.FileUtility.fileFor;
import static edu.gatech.gtri.trustmark.grails.trpt.service.job.JobUtilityForPartnerOrganizationCandidate.synchronizePartnerOrganizationCandidate;
import static edu.gatech.gtri.trustmark.grails.trpt.service.job.JobUtilityForPartnerSystemCandidate.synchronizePartnerSystemCandidate;
...
public class JobUtilityForTrustmarkBindingRegistry {
    ...
    public static void synchronizeTrustmarkBindingRegistryUriAndDependencies(final Duration duration) {
        ...
        JobUtilityForPartnerOrganizationCandidate.synchronizePartnerOrganizationCandidate(duration);
    }
    ...
    public static void synchronizeTrustmarkBindingRegistryUriAndDependencies(final Duration duration, final LocalDateTime now) {
        ...
        UriSynchronizerForTrustmarkBindingRegistryOrganizationMap.INSTANCE.synchronizeUri();
        JobUtilityForPartnerOrganizationCandidate.synchronizePartnerOrganizationCandidate(duration, now);
    }
