...
import edu.gatech.gtri.trustmark.grails.trpt.domain.OrganizationPartnerOrganizationCandidate;
import edu.gatech.gtri.trustmark.grails.trpt.domain.OrganizationTrustInteroperabilityProfileUri;
...
import static edu.gatech.gtri.trustmark.grails.trpt.service.job.JobUtilityForPartnerOrganizationCandidateTrustInteroperabilityProfileUri.synchronizePartnerOrganizationCandidateTrustInteroperabilityProfileUri;
import static edu.gatech.gtri.trustmark.grails.trpt.service.organization.OrganizationResponseUtility.organizationResponseWithDetail;
import static edu.gatech.gtri.trustmark.grails.trpt.service.organization.OrganizationResponseUtility.organizationResponseWithTrustExpressionEvaluation;
import static edu.gatech.gtri.trustmark.grails.trpt.service.organization.OrganizationValidationUtility.validationDescription;
import static edu.gatech.gtri.trustmark.grails.trpt.service.organization.OrganizationValidationUtility.validationId;
import static edu.gatech.gtri.trustmark.grails.trpt.service.organization.OrganizationValidationUtility.validationIdList;
import static edu.gatech.gtri.trustmark.grails.trpt.service.organization.OrganizationValidationUtility.validationName;
import static edu.gatech.gtri.trustmark.grails.trpt.service.organization.OrganizationValidationUtility.validationOrganizationTrustInteroperabilityProfileList;
import static edu.gatech.gtri.trustmark.grails.trpt.service.organization.OrganizationValidationUtility.validationPartnerOrganizationCandidate;
import static edu.gatech.gtri.trustmark.grails.trpt.service.organization.OrganizationValidationUtility.validationPartnerOrganizationCandidateList;
import static edu.gatech.gtri.trustmark.grails.trpt.service.organization.OrganizationValidationUtility.validationUri;
import static edu.gatech.gtri.trustmark.grails.trpt.service.permission.PermissionName.ORGANIZATION_DELETE;
import static edu.gatech.gtri.trustmark.grails.trpt.service.permission.PermissionName.ORGANIZATION_INSERT;
import static edu.gatech.gtri.trustmark.grails.trpt.service.permission.PermissionName.ORGANIZATION_SELECT;
import static edu.gatech.gtri.trustmark.grails.trpt.service.permission.PermissionName.ORGANIZATION_UPDATE;
...
public class OrganizationService {
    ...
    private Organization saveHelper(
        ...
        organization.organizationTrustInteroperabilityProfileUriSetHelper(organizationTrustInteroperabilityProfileList.map(organizationTrustInteroperabilityProfile -> {
            ...
            organizationTrustInteroperabilityProfileUri.trustInteroperabilityProfileUriHelper(TrustInteroperabilityProfileUtility.upsertTrustInteroperabilityProfileUri(organizationTrustInteroperabilityProfile._1()));
    ...
    public Validation<NonEmptyList<ValidationMessage<OrganizationField>>, OrganizationResponseWithTrustExpressionEvaluation> findOne(
        ...
        return userMay(requesterUsername, ORGANIZATION_SELECT, (requesterUser, requesterOrganizationList, requesterRoleList) -> findOneHelper(requesterUser, requesterOrganizationList, requesterRoleList, protectedEntityPartnerCandidateFindOneRequest));
    }
    ...
    private Validation<NonEmptyList<ValidationMessage<OrganizationField>>, OrganizationResponseWithTrustExpressionEvaluation> findOneHelper(
        ...
        return accumulate(
                ...
                validationPartnerOrganizationCandidate(protectedEntityPartnerCandidateFindOneRequest.getPartnerCandidate()),
