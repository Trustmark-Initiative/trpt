...
<sec:ifLoggedIn>
    <sec:ifAnyGranted roles="ROLE_USER,ROLE_ADMIN">
        <h3>Registries <small>(Total ${assessmentCount})</small></h3>
        ...
        <div id="relying-partyContainer"></div>
        <script type="text/javascript">
/*            $(document).ready(function(){
  ...
  */      </script>
        ...
        <div>
            <table class="table table-condensed table-striped table-bordered">
                ...
                <tbody>
                <tr>
                    <td colspan="3"><em>There are no Registries defined.</em></td>
                </tr>
                </tbody>
            </table>
        </div>
        <div>
            <a href="${createLink(controller:'admin', action: 'list')}" class="btn btn-primary">Manage &raquo;</a>
        </div>
    </sec:ifAnyGranted>
