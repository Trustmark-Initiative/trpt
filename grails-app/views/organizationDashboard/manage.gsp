<html>
    <head>
        ...
        <asset:javascript src="dashboard_manage_organization.js"/>
    ...
    <body>
        <div class="container pt-4 placeholder-glow">
            ...
            <div class="mt-2">
                Add trust interoperability profiles (TIPs${raw(grailsApplication.config.getProperty('server.artifact'))}) to this table to define the trust policy for <span class="entity-element-name placeholder-hack col-3"></span></span>.
            </div>
        ...
        <div class="container pt-4 placeholder-glow">
            <div class="fw-bold">Candidate Partner Organizations for <span class="entity-element-name placeholder-hack col-3"></span></div>

            <div class="mt-2">
                This table allows you to control which candidate partner organizations are trusted by <span class="entity-element-name placeholder-hack col-3"></span>.
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body d-none" id="modal-body-trust">
                        <p>
                            ...
                            to trust
                            <span class="partner-candidate-element-name fw-bold"></span>.</p>
                    ...
                    <div class="modal-body d-none" id="modal-body-do-not-trust">
                        <p>
                            ...
                            to stop trusting <span class="partner-candidate-element-name fw-bold"></span>.</p>

                        <p>Because you have chosen to stop trusting <span class="partner-candidate-element-name fw-bold"></span>,
