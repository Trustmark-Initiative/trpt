...
class TRPTProperties {

    private static final Logger log = LoggerFactory.getLogger(TRPTProperties.class)

    public static final String BUNDLE_NAME = "trpt_config.properties"
